...
//        MediaFile mediaFile = MAPPER.createObjectNode().set("media", media);
//
...
//        MediaFileEvent mediaFileEvent = new MediaFileEvent(1L, new MediaFile(1L, "path", null, "name", null, null, 0), null, null);
//        when(dataService.getMediaFileEvents(localDateTime)).thenReturn(List.of(mediaFileEvent));
//
//        List<MediaFileEvent> mediaFileEvents = mediaResource.getEvents(epoch);
//
